...
3. In the file navigator pop-up, navigate to the folder containing your unzipped files. Go inside, name the project, and click Ok.

You should now see a project open up (with the name at the top right corner of the RStudio screen). Your files should appear in the lower right panel.
...
Make sure you save your RMD to save your work.
