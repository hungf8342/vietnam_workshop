...
programming will not be covered in the in-person workshops. I will start
...
3.  In the file navigator pop-up, navigate to the folder containing your
    unzipped files. Go inside, name the project, and click Ok.
...
-   Environment: objects (i.e. dataframes) that we create will show up
    here. There is also a Git tab for easy version control.
