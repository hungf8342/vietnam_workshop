...
In linear regression, we fit a line to the data, where the dependent variables on the right-hand side of the equation consist of our measure of interest and potential confounders. You will notice that regression looks quite similar to ANOVA, except we can now include continuous variables as dependent variables.
